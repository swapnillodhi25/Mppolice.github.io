...
$connection = mysqli_connect("localhost","root","", "dutydatabase"); 
      
if(isset($_POST['search_by_id']))
{
$police_id= $_POST['get_id'];

$query = "SELECT * FROM transfertable WHERE police_id='$police_id'"; 
        ...
        ?>
          <tr>
            <th scope="row"><?php    echo $row['full_name'];    ?></th>
                    ...
                    <td><?php    echo $row['from_station_name'];    ?></td>
                    <td><?php    echo $row['to_station_name'];    ?></td>
