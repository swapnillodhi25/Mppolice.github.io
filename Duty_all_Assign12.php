...
<!-- form -->
  ...
  <form action="#" method="POST">
	<div class="container content">
      ...
      <center><h2>Please fill out the details to continue...</h2></center>
		<div class="input-group mb-3">
                ...
                <div class="input-group mb-3">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" name="area_of_duty" aria-label="Area of Duty" aria-describedby="basic-addon2">
                  </div>
				...
				<div class="input-group mb-3">
					<input type="submit" name="register" id= "button1"class="btn btn-default" value="Submit">
				</div>
			</div>
		</div>
  </form>
...
<!-- New Code -->
  ...
  if($_POST['register'])
  {
    ...
    $police_id =  $_POST['police_id'];
      ...
      $query=" INSERT INTO dutytable1 values (' $full_name',' $police_id',' $station_name',' $area_of_duty',' $date',' $start_time',' $end_time')";
