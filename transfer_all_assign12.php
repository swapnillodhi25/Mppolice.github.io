...
<div class="container header">
      ...
      </center><h2>Assign Transfer Form</h2></center>
			</div>
	...
	<div class="container content">
			...
			<h4>Please fill out the details to continue...</h4>
                ...
                <div class="input-group mb-3">
                  ...
                  <div class="input-group mb-3">
                    <div class="input-group-prepend">
                      <span class="input-group-text" id="basic-addon2">Transfered By</span>
                    </div>
				...
				<div class="input-group mb-3">
                <input type="submit" name="register"id="button3" class="btn btn-default" value="Submit">
				</div>
			</div>
		</div>
  </form>
...
<!-- New Code -->
  ...
  if($_POST['register'])
  {
    ...
    $end_time =  $_POST['end_time'];
      ...
      $query=" INSERT INTO transfertable values (' $full_name',' $police_id',' $from_station_name',' $to_station_name',' $date',' $start_time',' $end_time')";
