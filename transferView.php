...
<?php
    while($result = mysqli_fetch_assoc($data))
    {
        ...
        <td><a href='transferUpdate.php?id=$result[police_id]'> <input type='submit'  value='Update' class='update'></a>
        <a href='transferView.php?police_id=".$result['police_id']."' id='btn' onclick='return checkdelete()' ><input type='submit'  value='Delete' class='delete'></a></td> 
    </tr>
    ";
    }
}
