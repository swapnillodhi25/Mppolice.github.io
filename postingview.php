...
if (isset($_GET['police_id'])) {  
  ...
  $delete = "DELETE FROM postingtable WHERE police_id = '$police_id'";  
  $run1 = mysqli_query($conn,$delete);  
  if ($run1) {  
       header('postingview.php');  
  }else{  
       echo "Error: ".mysqli_error($conn);  
  }  
} 
$query = "select * from postingtable";
...
<h2> Display All Posting  Data<h2>
...
<?php
    while($result = mysqli_fetch_assoc($data))
    {
        ...
        <td><a href='postingupdate.php?id=$result[police_id]'> <input type='submit'  value='Update' class='update'></a>
        <a href='postingview.php?police_id=".$result['police_id']."' id='btn' onclick='return checkdelete()' ><input type='submit'  value='Delete' class='delete'></a></td> 
    </tr>
    ";
    }
}
