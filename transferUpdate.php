...
$query = "select * from transfertable where police_id='$id'";
...
<div class="container header">
		<div class="row">
			...
			<div class="col-md-6 header-center">
				<h4>Update Assign Transfer Form</h4>
			</div>
	...
	<div class="container content">
			...
			<h4>Please fill out the details to continue...</h4>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text"    value="<?php echo $result['from_station_name']?>" class="form-control" name="from_station_name" aria-label="Station" aria-describedby="basic-addon2">
                  </div>
                  <div class="input-group mb-3">
                    <div class="input-group-prepend">
                      <span class="input-group-text" id="basic-addon2">To Station name</span>
                    </div>
                    <input type="text"   value="<?php echo $result['to_station_name']?>"class="form-control" name="to_station_name" aria-label="to_station_name" aria-describedby="basic-addon2">
                  </div>
				...
				<div class="input-group mb-3">
					<input type="submit" onclick='return transferupdatemessage()' name="update" id="update3"class="btn btn-default" value= "Update Details">
				</div>
			</div>
		</div>
  </form>
...
if($_POST['update'])
{
  ...
  $query ="UPDATE transfertable set full_name='$full_name',police_id=' $police_id ',from_station_name='$from_station_name',to_station_name=' $to_station_name', date='$date',  start_time=' $start_time' , end_time=' $end_time' WHERE police_id='$id'";
