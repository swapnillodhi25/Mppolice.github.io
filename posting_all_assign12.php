...
<div class="container header">
		<div class="row">
			...
			<div class="col-md-6 header-center">
				<center><h2>Assign Posting Form</h2></center>
			</div>
	...
	<div class="container content">
			...
			<h4>Please fill out the details to continue...</h4>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" name="station_name" aria-label="Station" aria-describedby="basic-addon2">
                  </div>
                  <div class="input-group mb-3">
                    <div class="input-group-prepend">
                      <span class="input-group-text" id="basic-addon2">Area</span>
                    </div>
                    <input type="text" class="form-control" name="area" aria-label="Area of Duty" aria-describedby="basic-addon2">
                  </div>
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control"  name="start_time" aria-label="Area of Duty" aria-describedby="basic-addon2">
                  </div>
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" name="end_time" aria-label="End Time" aria-describedby="basic-addon2">
                  </div>
				...
				<div class="input-group mb-3">
                <input type="submit" name="register"id="button2" class="btn btn-default"  id="button2"value="Submit">
				</div>
			</div>
		</div>
  </form>
...
<!-- New Code -->
  ...
  if($_POST['register'])
  {
    ...
    $police_id =  $_POST['police_id'];
      ...
      $query=" INSERT INTO postingtable values (' $full_name',' $police_id',' $station_name',' $area',' $date',' $start_time',' $end_time')";
